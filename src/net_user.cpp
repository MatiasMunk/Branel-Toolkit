...
NET_API_STATUS NetUserManager::GetLocalGroup(LPWSTR lpszLocalGroup)
{
...
NET_API_STATUS NetUserManager::CreateLocalGroup( LPWSTR lpszLocalGroup )
{
    LOCALGROUP_INFO_1           localgroup_info;
    LPWSTR                      lpszPrimaryDC = NULL;
    NET_API_STATUS              err = 0;
...
NET_API_STATUS NetUserManager::AddUserToGroup( LPWSTR lpszUser,
